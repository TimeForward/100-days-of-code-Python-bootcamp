...
if one.lower()=="left":
  ...
  if two.lower()=="wait":
    three=input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose? Red, blue or yellow.")
    if three.lower()=="red":
